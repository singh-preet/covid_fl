...
class HomeController extends GetxController{
  ...
  List<BottomNavigationBarItem> items=[
    BottomNavigationBarItem(icon: Icon(Icons.access_alarm),label: StringConstant.ACTIONS),
    BottomNavigationBarItem(icon: Icon(Icons.timeline),label: StringConstant.TIMELINE),
    BottomNavigationBarItem(icon: Icon(Icons.pregnant_woman),label: StringConstant.STAFF),
  ];
